...
public class correctParameters extends JFrame {
	...
	private boolean updateDBScheme() {
		...
		try {
			...
			start.cn.setSchema("-- MySQL Script generated by MySQL Workbench\r\n" + 
					"-- 10/04/15 18:06:13\r\n" + 
					...
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Table `mydb`.`patientendaten`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`patientendaten` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`patientendaten` (\r\n" + 
					...
					"-- Table `mydb`.`fall`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`fall` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`fall` (\r\n" + 
					...
					"-- Table `mydb`.`tumor`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`tumor` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`tumor` (\r\n" + 
					...
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Table `mydb`.`fall_has_tumor`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`fall_has_tumor` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`fall_has_tumor` (\r\n" + 
					...
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Table `mydb`.`klassifikation`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`klassifikation` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`klassifikation` (\r\n" + 
					"  `Fall_E.-Nummer` VARCHAR(15) NOT NULL COMMENT '',\r\n" + 
					...
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Table `mydb`.`medikation`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`medikation` ;\r\n" + 
					"\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`medikation` (\r\n" + 
					...
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Placeholder table for view `mydb`.`vfallmitnamen`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`vfallmitnamen` (`E.-Nummer` INT, `Befundtyp` INT, `Arzt` INT, `Eingangsdatum` INT, `Einsender` INT, `Fehler` INT, `PatientenID` INT, `Geburtsdatum` INT, `Vorname` INT, `Name` INT);\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Placeholder table for view `mydb`.`vfehlerfall`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`vfehlerfall` (`E.-Nummer` INT, `Befundtyp` INT, `Arzt` INT, `Eingangsdatum` INT, `Einsender` INT, `Fehler` INT, `PatientenID` INT, `Geburtsdatum` INT, `Vorname` INT, `Name` INT);\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Placeholder table for view `mydb`.`vpatientendaten_hauptparameter`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`vpatientendaten_hauptparameter` (`PatientenID` INT, `Vorname` INT, `Name` INT, `Geburtsdatum` INT, `Strasse` INT, `Hausnummer` INT, `Land` INT, `PLZ` INT, `Ort` INT, `Fehler` INT);\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- Placeholder table for view `mydb`.`vpatientenkeyelements`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"CREATE TABLE IF NOT EXISTS `mydb`.`vpatientenkeyelements` (`PatientenID` INT, `Geburtsdatum` INT, `Vorname` INT, `Name` INT);\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- View `mydb`.`vfallmitnamen`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP VIEW IF EXISTS `mydb`.`vfallmitnamen` ;\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`vfallmitnamen`;\r\n" + 
					"USE `mydb`;\r\n" + 
					"CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mydb`.`vfallmitnamen` AS select `mydb`.`fall`.`E.-Nummer` AS `E.-Nummer`,`mydb`.`fall`.`Befundtyp` AS `Befundtyp`,`mydb`.`fall`.`Arzt` AS `Arzt`,`mydb`.`fall`.`Eingangsdatum` AS `Eingangsdatum`,`mydb`.`fall`.`Einsender` AS `Einsender`,`mydb`.`fall`.`Fehler` AS `Fehler`,`mydb`.`fall`.`Patientendaten_PatientenID` AS `PatientenID`,`pat`.`Geburtsdatum` AS `Geburtsdatum`,`pat`.`Vorname` AS `Vorname`,`pat`.`Name` AS `Name` from (`mydb`.`fall` left join `mydb`.`patientendaten` `pat` on((`mydb`.`fall`.`Patientendaten_PatientenID` = `pat`.`PatientenID`)));\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- View `mydb`.`vfehlerfall`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP VIEW IF EXISTS `mydb`.`vfehlerfall` ;\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`vfehlerfall`;\r\n" + 
					"USE `mydb`;\r\n" + 
					"CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mydb`.`vfehlerfall` AS select `mydb`.`fall`.`E.-Nummer` AS `E.-Nummer`,`mydb`.`fall`.`Befundtyp` AS `Befundtyp`,`mydb`.`fall`.`Arzt` AS `Arzt`,`mydb`.`fall`.`Eingangsdatum` AS `Eingangsdatum`,`mydb`.`fall`.`Einsender` AS `Einsender`,`mydb`.`fall`.`Fehler` AS `Fehler`,`mydb`.`fall`.`Patientendaten_PatientenID` AS `PatientenID`,`pat`.`Geburtsdatum` AS `Geburtsdatum`,`pat`.`Vorname` AS `Vorname`,`pat`.`Name` AS `Name` from (`mydb`.`fall` left join `mydb`.`patientendaten` `pat` on((`mydb`.`fall`.`Patientendaten_PatientenID` = `pat`.`PatientenID`))) where (`mydb`.`fall`.`Fehler` <> 0);\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- View `mydb`.`vpatientendaten_hauptparameter`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP VIEW IF EXISTS `mydb`.`vpatientendaten_hauptparameter` ;\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`vpatientendaten_hauptparameter`;\r\n" + 
					"USE `mydb`;\r\n" + 
					"CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mydb`.`vpatientendaten_hauptparameter` AS select `mydb`.`patientendaten`.`PatientenID` AS `PatientenID`,`mydb`.`patientendaten`.`Vorname` AS `Vorname`,`mydb`.`patientendaten`.`Name` AS `Name`,`mydb`.`patientendaten`.`Geburtsdatum` AS `Geburtsdatum`,`mydb`.`patientendaten`.`Strasse` AS `Strasse`,`mydb`.`patientendaten`.`Hausnummer` AS `Hausnummer`,`mydb`.`patientendaten`.`Land` AS `Land`,`mydb`.`patientendaten`.`PLZ` AS `PLZ`,`mydb`.`patientendaten`.`Ort` AS `Ort`,`mydb`.`patientendaten`.`Fehler` AS `Fehler` from `mydb`.`patientendaten`;\r\n" + 
					"\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"-- View `mydb`.`vpatientenkeyelements`\r\n" + 
					"-- -----------------------------------------------------\r\n" + 
					"DROP VIEW IF EXISTS `mydb`.`vpatientenkeyelements` ;\r\n" + 
					"DROP TABLE IF EXISTS `mydb`.`vpatientenkeyelements`;\r\n" + 
					"USE `mydb`;\r\n" + 
					"CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mydb`.`vpatientenkeyelements` AS select `mydb`.`patientendaten`.`PatientenID` AS `PatientenID`,`mydb`.`patientendaten`.`Geburtsdatum` AS `Geburtsdatum`,`mydb`.`patientendaten`.`Vorname` AS `Vorname`,`mydb`.`patientendaten`.`Name` AS `Name` from `mydb`.`patientendaten`;\r\n" + 
					"USE `mydb`;\r\n" + 
					"\r\n" + 
					"DELIMITER $$\r\n" + 
					"\r\n" + 
					"USE `mydb`$$\r\n" + 
					"DROP TRIGGER IF EXISTS `mydb`.`trDeletePatient` $$\r\n" + 
					"USE `mydb`$$\r\n" + 
					"CREATE\r\n" + 
					...
					"\r\n" + 
					"USE `mydb`$$\r\n" + 
					"DROP TRIGGER IF EXISTS `mydb`.`trDoppeltePatienten` $$\r\n" + 
					"USE `mydb`$$\r\n" + 
					"CREATE\r\n" + 
					"DEFINER=`root`@`localhost`\r\n" + 
					...
					"\r\n" + 
					"USE `mydb`$$\r\n" + 
					"DROP TRIGGER IF EXISTS `mydb`.`trUpdateDoppeltePatienten` $$\r\n" + 
					"USE `mydb`$$\r\n" + 
					"CREATE\r\n" + 
					"DEFINER=`root`@`localhost`\r\n" + 
					...
					"\r\n" + 
					"USE `mydb`$$\r\n" + 
					"DROP TRIGGER IF EXISTS `mydb`.`trDeleteFall` $$\r\n" + 
					"USE `mydb`$$\r\n" + 
					"CREATE\r\n" + 
					"DEFINER=`root`@`localhost`\r\n" + 
					...
					"\r\n" + 
					"USE `mydb`$$\r\n" + 
					"DROP TRIGGER IF EXISTS `mydb`.`trPatientenIDnull` $$\r\n" + 
					"USE `mydb`$$\r\n" + 
					"CREATE\r\n" + 
					"DEFINER=`root`@`localhost`\r\n" + 
